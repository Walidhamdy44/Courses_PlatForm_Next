...
const CourseSideBarItem = ({ cha, courseId }: any) => {
  ...
  return (
    <div
      className={cn(
        "bg-white cursor-pointer border-b-2 border-gray-400 w-full text-gray-500  pl-[20px] py-[20px] text-center flex items-center gap-6 hover:text-green-500 hover:bg-gray-200 transition",
